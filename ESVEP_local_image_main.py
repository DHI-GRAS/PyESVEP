...
from pyESVEP.ESVEPConfigFileInterface import ESVEPConfigFileInterface

config_file = 'Config_LocalImage.txt'


def run_ESVEP_from_config_file(config_file):
    # Create an interface instance
    setup = ESVEPConfigFileInterface()
...
if __name__ == '__main__':
    ...
    if len(args) > 1:
        config_file = args[1]
    print('Run pyESVEP with configuration file = ' + str(config_file))
    run_ESVEP_from_config_file(config_file)
